...
import com.example.swadebuilder.ui.components.ExpandableSettingsSection
                ...
                AlertDialog(
                    ...
                    text = {
                        Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
                            ...
                            ExpandableSettingsSection(title = "Preferências Gerais") {
                                Row(
                            ...
                            ExpandableSettingsSection(title = "Personalização") {
                                Row(
                                    modifier = Modifier.fillMaxWidth(),
                                    verticalAlignment = Alignment.CenterVertically,
                                    horizontalArrangement = Arrangement.SpaceBetween
                            ...
                            ExpandableSettingsSection(title = "Interações e Efeitos") {
