...
fun VantagensContent(
    ...
    val headerContent: @Composable () -> Unit = {
        Column {
            SectionHeader(
                onHelpClick = null,
                centerText = "Pontos de Vantagem: ${state.pontosVantagem} (${pcLivres / 2} PB)",
            ...
            if (!state.emProgresso) {
                ...
                if (usePbWalletRedesign) {
                    PbWalletBanner(
                        pcTotal = pcTotal,
                        pcLivres = pcLivres,
                        spendLabel = "PB usado automaticamente ao comprar Vantagens",
                        refundLabel = "PB devolvido automaticamente ao remover",
                        spendEnabled = false,
                        refundEnabled = false,
                        onSpend = {},
                        onRefund = {}
