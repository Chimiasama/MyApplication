...
private enum class SuperCategory(val label: String, val icon: String) {
    TODOS("Todos", ""),
    COMBATE_OFENSIVO("Combate", "⚔️"),
    DEFESA_PROTECAO("Defesa", "🛡️"),
    MOVIMENTO_MOBILIDADE("Movimento", "🏃"),
    FISIOLOGIA_METAMORFOSE("Fisiologia", "🧬"),
    PSIQUICO_MENTAL("Mental", "🧠"),
    MANIPULACAO_ELEMENTAL("Elemental", "🌪️"),
    SUPORTE_CURA("Suporte/Cura", "🩹"),
    PERICIAS_CAPACITACAO("Capacitação", "📊"),
    TECNOLOGIA_INFORMACAO("Tecnologia", "💻"),
    INVOCACAO_SEGUIDORES("Invocação", "👥");
    ...
    companion object {
        fun fromPowerName(nome: String): SuperCategory {
            ...
            return when {
                ...
                key in listOf("ANDAR_NAS_PAREDES", "AQUATICO", "BALANCAR", "CAVAR", "ESPACIAL", "MOVIMENTACAO", "SALTO", "TELEPORTE", "VELOCIDADE", "VOO") -> MOVIMENTO_MOBILIDADE
                key in listOf("ALCANCE", "CAMALEAO", "CONSTRUTO", "CRESCIMENTO", "ENCOLHIMENTO", "FORMA_ALTERNATIVA", "MEMBROS_EXTRAS", "MORTO_VIVO", "MUDANCA_DE_FORMA", "NAO_COME", "NAO_DORME", "NAO_ENVELHECE", "NAO_RESPIRA") -> FISIOLOGIA_METAMORFOSE
                key in listOf("ATORDOAR", "CEGAR", "CONTROLE_MENTAL", "DESTEMIDO", "ILUSAO", "LEITURA_MENTAL", "LENTIDAO", "MA_SORTE", "MEDO", "OBSCURECER", "POSSESSAO", "TELEPATIA") -> PSIQUICO_MENTAL
                key in listOf("CONTROLE_DE_CLIMA", "CONTROLE_DE_ENERGIA", "CONTROLE_DE_MATERIA", "DECOMPOR", "EMPURRAR", "ENREDAR", "TELECINESE") -> MANIPULACAO_ELEMENTAL
                key in listOf("ANULAR", "AUMENTAR_REDUZIR_CARACTERISTICA", "CURAR", "REFLEXOS_APRIMORADOS", "REGENERACAO") -> SUPORTE_CURA
                key in listOf("ACOES_ADICIONAIS", "APARAR", "BONUS_DE_PERICIA", "GENIO", "MIMETISMO", "PERCEPTIVO", "SUPERATRIBUTO", "SUPER_ATRIBUTO", "SUPERPERICIA", "SUPER_PERICIA", "SUPERVANTAGEM", "SUPER_VANTAGEM") -> PERICIAS_CAPACITACAO
                key in listOf("CONTROLAR_MAQUINAS", "CONTROLE_DE_MAQUINAS", "ESCANEAR", "FALAR_IDIOMA", "INTERFACE", "LEITURA_DE_OBJETO", "MAU_FUNCIONAMENTO", "SENTIDOS_APRIMORADOS", "SUPERCIENCIA", "SUPERFEITICARIA", "TRANSMISSAO", "VEICULO") -> TECNOLOGIA_INFORMACAO
                key in listOf("COMPANHEIRO_ANIMAL", "CONTROLE_DE_ANIMAL", "DUPLICACAO", "SERVOS") -> INVOCACAO_SEGUIDORES
                else -> PERICIAS_CAPACITACAO
            }
        }
    }
}
