...
import com.example.swadebuilder.ui.components.SettingsSectionHeader
...
fun TelaInicial(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            // --- Compêndios Section ---
            item { SettingsSectionHeader("Compêndios & Cenários") }
            ...
            item { SettingsSectionHeader("Regras de Criação") }
