...
fun TelaInicial(
    ...
    var expandedCenarios by rememberSaveable { mutableStateOf(false) }
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            // --- Módulos Básicos Section (Always Visible) ---
            ...
            item {
                Column(
                    ...
                    RuleGroupCard(
                        ...
                        expanded = expandedCenarios,
                        onToggle = { expandedCenarios = !expandedCenarios }
                    ) {
                        ModuleToggle(
