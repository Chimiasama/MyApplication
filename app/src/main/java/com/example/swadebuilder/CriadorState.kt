...
class CriadorState {
    ...
    private fun atributoBaseRacial(a: String): Int {
        ...
        if (ancestralidade.keyify() == "descendente_elemental" || ancestralidade.keyify() == "desc_elemental") {
    ...
    fun aplicarAncestralidade(anc: String, feedbackMessages: MutableList<String>) {
        ...
        if (anc.keyify() != "descendente_elemental" && anc.keyify() != "desc_elemental") {
